    ...
    <div class="w-full">
        ...
        <div class="w-full flex justify-center">
            <div class="w-[32rem] border shadow rounded-md p-10">
                <h1 class="text-center font-bold text-xl">TAMBAH DATA RIWAYAT PEKERJAAN</h1>
                ...
                <form method="POST" class="mt-6 w-full flex flex-col gap-3" enctype="multipart/form-data">
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required name="namaAum" value="{{ old('namaAum') }}" type="text" placeholder="nama AUM"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="nomerAum" value="{{ old('nomerAum') }}" type="text" placeholder="xxxxxx"
                            class="input input-bordered w-full" />
                        @error('nomerAum')
                            <p class="text-xs text-red-400">*{{ $message }}</p>
                        @enderror
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="namaPenandatangan" value="{{ old('namaPenandatangan') }}" type="text"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="jabatanPenandaTangan" value="{{ old('jabatanPenandaTangan') }}" type="text"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="nomerSK" value="{{ old('nomerSK') }}" type="text" placeholder="xxxxxx"
                            class="input input-bordered w-full" />
                        @error('nomerSK')
                            <p class="text-xs text-red-400">*{{ $message }}</p>
                        @enderror
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="tanggalSK" value="{{ old('tanggalSK') }}" type="date"
                            class="input input-bordered w-full" />
                        @error('tanggalSK')
                            <p class="text-xs text-red-400">*{{ $message }}</p>
                        @enderror
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="masaKerjaDalamBulan" value="{{ old('masaKerjaDalamBulan') }}" type="number"
                            placeholder="0" min="1" max="1000" class="input input-bordered w-full" />
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required type="file" name="buktiSK" accept=".pdf"
