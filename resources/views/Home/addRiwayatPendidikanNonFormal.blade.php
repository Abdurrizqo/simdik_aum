    ...
    <div class="w-full">
        ...
        <div class="w-full flex justify-center">
            ...
            <div class="w-[32rem] border shadow rounded-md p-10">
                <h1 class="text-center font-bold text-xl">TAMBAH DATA RIWAYAT PENDIDIKAN NON FORMAL</h1>
                ...
                <form method="POST" class="mt-6 w-full flex flex-col gap-3" enctype="multipart/form-data">
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required name="lembagaPenyelenggara" value="{{ old('lembagaPenyelenggara') }}" type="text"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="jenisDiklat" value="{{ old('jenisDiklat') }}" type="text" placeholder="jenis diklat"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="tingkat" value="{{ old('tingkat') }}" type="text" placeholder="tingkat"
                            class="input input-bordered w-full" />
                        @error('tingkat')
                            <p class="text-xs text-red-400">*{{ $message }}</p>
                        @enderror
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required type="file" name="sertifikat" accept=".pdf"
