    ...
    <div class="w-full">
        ...
        <div class="w-full flex justify-center">
            <div class="w-[32rem] border shadow rounded-md p-10">
                <h1 class="text-center font-bold text-xl">EDIT DATA RIWAYAT PENDIDIKAN FORMAL</h1>
                ...
                <form method="POST" class="mt-6 w-full flex flex-col gap-3" enctype="multipart/form-data">
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required name="lembagaPendidikan" value="{{ $riwayatPendidikanFormal['lembagaPendidikan'] }}"
                            type="text" placeholder="asal lembaga pendidikan" class="input input-bordered w-full" />
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="fakultas" value="{{ $riwayatPendidikanFormal['fakultas'] }}" type="text"
                            placeholder="fakultas" class="input input-bordered w-full" />
                        @error('fakultas')
                            <p class="text-xs text-red-400">*{{ $message }}</p>
                        @enderror
                    </label>
                    ...
                    <label class="form-control w-full">
                        ...
                        <input name="jurusanProgStud" value="{{ $riwayatPendidikanFormal['jurusanProgStud'] }}"
                            type="text" placeholder="Jurusan / Program Studi" class="input input-bordered w-full" />
                    ...
                    <label class="form-control w-full">
                        ...
                        <input required name="tahunLulus" value="{{ $riwayatPendidikanFormal['tahunLulus'] }}"
                    ...
                    <label class="form-control w-full">
                        ...
                        <input type="file" name="ijazah" accept=".pdf"
